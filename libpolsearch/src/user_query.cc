...
polsearch_user_query::polsearch_user_query(polsearch_match m) throw(std::invalid_argument):polsearch_query(m)
{
	//nothing more to do
}
...
polsearch_element polsearch_user_query::elementType() const
{
