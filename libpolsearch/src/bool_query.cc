...
polsearch_bool_query::polsearch_bool_query(polsearch_match m) throw(std::invalid_argument):polsearch_query(m)
{
	//nothing more to do
}
...
polsearch_element polsearch_bool_query::elementType() const
{
