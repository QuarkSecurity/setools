 ...
 * @return Always 0.
 */
	extern int apol_role_allow_query_set_icase(const apol_policy_t * p, apol_role_allow_query_t * r, int is_icase);
...
/**
 * Set a roletrans query to be case insensitive. This flag applies to regular
 ...
 * @return Always 0.
 */
	extern int apol_role_trans_query_set_icase(const apol_policy_t * p, apol_role_trans_query_t * r, int is_icase);
