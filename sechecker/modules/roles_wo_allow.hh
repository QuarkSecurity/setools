...
namespace sechk
{
	class roles_wo_allow_module:public module
	{
	      public:
		/**
		 * Create a roles without allow rules module.
		 ...
		 */
		roles_wo_allow_module() throw(std::invalid_argument, std::out_of_range);

		/**
			 * Copy a roles without allow rules module.
			 * @param rhs The module to copy.
		 */
		roles_wo_allow_module(const roles_wo_allow_module & rhs);

		//! Destructor.
		 virtual ~roles_wo_allow_module();
