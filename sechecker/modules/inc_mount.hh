...
#ifndef SECHECKER_MODULE_INC_MOUNT
#define SECHECKER_MODULE_INC_MOUNT
...
namespace sechk
{
	class inc_mount_module:public module
	{
	      public:
		/**
		 * Create a incomplete mount permissions module.
		 ...
		 */
		inc_mount_module() throw(std::invalid_argument, std::out_of_range);

		/**
		 * Copy a incomplete mount permissions module.
		 * @param rhs The module to copy.
		 */
		inc_mount_module(const inc_mount_module & rhs);

		//! Destructor.
		 virtual ~inc_mount_module();
...
#endif				       /* SECHECKER_MODULE_INC_MOUNT */
