/**
 *  @file
 *  Defines the interface for the find node types utility module.
 *
...
namespace sechk
{
	class find_node_types_module:public module
	{
	      public:
		/**
		 * Create a find node types module.
		 ...
		 */
		find_node_types_module() throw(std::invalid_argument, std::out_of_range);

		/**
			 * Copy a find node types module.
			 * @param rhs The module to copy.
		 */
		find_node_types_module(const find_node_types_module & rhs);

		//! Destructor.
		 virtual ~find_node_types_module();
