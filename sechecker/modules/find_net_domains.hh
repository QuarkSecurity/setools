/**
 *  @file
 *  Defines the interface for the find network domains utility module.
 *
...
#ifndef SECHECKER_MODULE_FIND_NET_DOMAINS
#define SECHECKER_MODULE_FIND_NET_DOMAINS
...
namespace sechk
{
	class find_net_domains_module:public module
	{
	      public:
		/**
		 * Create a find network domains module.
		 ...
		 */
		find_net_domains_module() throw(std::invalid_argument, std::out_of_range);

		/**
		 * Copy a find network domains module.
		 * @param rhs The module to copy.
		 */
		find_net_domains_module(const find_net_domains_module & rhs);

		//! Destructor.
		 virtual ~find_net_domains_module();
...
#endif				       /* SECHECKER_MODULE_FIND_NET_DOMAINS */
