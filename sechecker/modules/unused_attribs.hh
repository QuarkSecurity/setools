/**
 *  @file
 *  Defines the interface for the unused attributes module.
 *
...
#ifndef SECHECKER_MODULE_UNUSED_ATTRIBS
#define SECHECKER_MODULE_UNUSED_ATTRIBS
...
namespace sechk
{
	class unused_attribs_module:public module
	{
	      public:
		/**
		 * Create an unused attributes module.
		 ...
		 */
		unused_attribs_module() throw(std::invalid_argument, std::out_of_range);

		/**
		 * Copy an unused attributes module.
		 * @param rhs The module to copy.
		 */
		unused_attribs_module(const unused_attribs_module & rhs);

		//! Destructor.
		 virtual ~unused_attribs_module();
...
#endif				       /* SECHECKER_MODULE_UNUSED_ATTRIBS */
